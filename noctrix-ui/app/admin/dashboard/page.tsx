        ...
        <div className="flex min-h-screen">
            <div className="w-64 h-screen flex flex-col border-r bg-background p-6 fixed left-0 top-0">
                ...
                <nav className="space-y-2 flex-1">
                    ...
                    <Link href="/analyst/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:bg-muted/50 hover:text-foreground transition-colors">
            ...
            <div className="flex-1 flex flex-col ml-64 h-screen overflow-y-auto">
                <header className="border-b bg-background px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-black dark:text-teal-400">Admin Dashboard</h2>
                            <p className="text-muted-foreground mt-1">
                                Monitor system analytics and manage user accounts.
                            </p>
                        </div>
