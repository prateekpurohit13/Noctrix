...
class ReportingAgent(BaseAgent):
    def __init__(self):
        super().__init__("ReportingAgent", "1.1.0-Robust")
    ...
    def _transform_data_to_context(self, pipeline_data: dict) -> dict:
        ...
        context["compliance"] = {"mappings": [{"standard": "NIST CSF", "mapping": "PR.AC-1, PR.IP-4"}]}
    ...
    def process(self, task: AgentTask, progress_callback: callable = None) -> AgentResult:
        ...
        mappings_to_encrypt = {}
        # Use .get() to safely access the entities list
